...
def uaku():
	try:
		...
		a=requests.get('https://github.com/Rdx337/Sabbiropi/blob/main/Ap.txtt').text
		ua=open('.bbnew.txt','w')
  ...
  #  print("To stop process press CTRL c")
    ...
    def rana(user):
        ...
        #        print('\r{}\033[1;94m[2F-KING] {} {} {} {}'.format(G, url, fax, px, mys))
                ...
                #print(response.text)
                continue
        sys.stdout.write('\r {} [SABBIR] [{}|{}] [OK:{}] {}\r'.format(mys, str(loop), str(len(idx)), str(len(oku)) ,mys))
        sys.stdout.flush()
        loop += 1       
...
def menu(): 
			...
			if xd in ['1','01']:
				...
				os.system(f'xdg-open https://wa.me/+8801840762780');menu()
			elif xd in ['0','00']:
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [ SABBIR ] [%s] [\033[1;37mOK : %s ] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
